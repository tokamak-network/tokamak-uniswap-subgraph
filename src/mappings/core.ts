...
import { findEthPerToken, getEthPriceInUSD, getTonPriceInUSD, getTrackedAmountUSD, sqrtPriceX96ToTokenPrices } from '../utils/pricing'
import {
  updatePoolDayData,
  updatePoolHourData,
  updateTickDayData,
...
export function handleInitialize(event: Initialize): void {
  ...
  token0.derivedTON = findEthPerToken(token0 as Token)
  token1.derivedTON = findEthPerToken(token1 as Token)
  token0.save()
  token1.save()
}
